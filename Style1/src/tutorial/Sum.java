...
public class Sum extends Style {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nfunction===========");
		def<Integer> func = $((Integer i, Integer end, def<Integer> fun) -> {
			if (i < end) {
		...
		Map<String, Integer> testMap = $(new HashMap<>(), map("cass", 1995).$("cassie", 1996).$("unknown", 2001));
