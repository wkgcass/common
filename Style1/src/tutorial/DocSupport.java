...
public class DocSupport extends Style {
	...
	public static void main(String[] args) {
		...
		// 函数式编程 － 创建
		def<Integer> foo = function((Integer i, def<Integer> func) -> i > 99 ? i : i + func.apply(i + 1, func));
		...
		def<Object> funcWithCallback = function(
				(Integer sum, Integer cursor, def<Object> func, def<Object> callback) -> {
					if (cursor > 99)
		...
		Map<String, Integer> map = $(new HashMap<String, Integer>(), map("cass", 1995).$("john", 1994).$("cassie", 1996));
		// 集合－foreach,forthose
