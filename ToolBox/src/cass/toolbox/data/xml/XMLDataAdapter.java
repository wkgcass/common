...
import cass.toolbox.data.DataAdapter;

public class XMLDataAdapter implements DataAdapter {
	
	private Document doc;
	
	public XMLDataAdapter(File file) throws Exception{
		this(new FileInputStream(file));
	}
	public XMLDataAdapter(InputStream is) throws Exception{
	...
	public Object getProperty(Object key) {
		if(key instanceof String){
			...
			if(lastPos.startsWith("list")
				...
				if(lastPos.startsWith("list")){
					return this.parseList(node, additionalConfig);
				}else if(lastPos.startsWith("set")){
					return this.parseSet(node, additionalConfig);
				}else if(lastPos.startsWith("map")){
					return this.parseMap(node, additionalConfig);
				}else{
					return null;
				}
			}else{
