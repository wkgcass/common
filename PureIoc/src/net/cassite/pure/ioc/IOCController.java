...
public abstract class IOCController {
        ...
        /**
         * objects of external classes requires wiring when going through pure.ioc
         */
        private static Set<Class<?>> externalToWire = new HashSet<>();
         ...
         */
        protected static Object constructObject(@SuppressWarnings("rawtypes") Class cls) {
         ...
         */
        @SuppressWarnings("unchecked")
        protected static Object getObject(@SuppressWarnings("rawtypes") Class cls) {
        ...
        @SuppressWarnings("unchecked")
        protected static <T> T retrieveConstant(Class<T> type) {
        ...
        /**
         * get targeted variable(methods/fields) and invoke/get it.
         *
         * @param variable
         * @return
         */
        ...
        /**
         * register an external class, instance of which will be wired with default behavior
         *
         * @param cls class
         */
        public static void registerExternalClass(Class<?> cls) {
                externalToWire.add(cls);
        }

        /**
         * whether instance of the given class requires wiring
         *
         * @param cls class
         * @return true if requires wiring, false otherwise
         */
        protected static boolean externalRequiresWiring(Class<?> cls) {
                return externalToWire.contains(cls);
        }
}
